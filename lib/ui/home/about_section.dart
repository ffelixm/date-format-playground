...
designed for exploring and playing with the available formatting options. It
also provides a brief reference of all format symbols and formatting skeletons.
<br>
